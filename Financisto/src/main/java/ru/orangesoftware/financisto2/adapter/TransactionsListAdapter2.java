...
public class TransactionsListAdapter2 extends BlotterListAdapter2 {

    public TransactionsListAdapter2(Context context, Cursor cursor) {
    ...
    public void onBindViewHolder(final BlotterViewHolder v, Cursor cursor) {
        ...
        Currency c = CurrencyCache.getCurrencyOrEmpty(currencyId);
