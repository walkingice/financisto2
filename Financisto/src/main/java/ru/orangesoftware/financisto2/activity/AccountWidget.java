...
public class AccountWidget extends AppWidgetProvider {
    ...
    private static final String WIDGET_UPDATE_ACTION = "ru.orangesoftware.financisto2.UPDATE_WIDGET";
    private static final String PREFS_NAME = "ru.orangesoftware.financisto2.activity.AccountWidget";
