 ...
 ******************************************************************************/
package ru.orangesoftware.financisto2.filter;
...
import ru.orangesoftware.financisto2.activity.DateFilterActivity;
...
public class WhereFilter implements Parcelable {
    ...
    public static final Parcelable.Creator<WhereFilter> CREATOR = new Parcelable.Creator<WhereFilter>() {
        public WhereFilter createFromParcel(Parcel in) {
            return fromParcel(in);
        }

        public WhereFilter[] newArray(int size) {
            return new WhereFilter[size];
        }
    };
    ...
    public void writeToParcel(Parcel out, int flags) {
        ...
        out.writeStringArray(extras);
        out.writeString(getSortOrder());
    }

    public static WhereFilter fromParcel(Parcel parcel) {
        String title = parcel.readString();
        WhereFilter filter = new WhereFilter(title);
        String[] a = parcel.createStringArray();
        if (a != null) {
            for (String s : a) {
                filter.put(Criteria.fromStringExtra(s));
            }
        }
        String sortOrder = parcel.readString();
        if (sortOrder != null) {
    ...
    public void toBundle(Bundle bundle) {
        bundle.putParcelable(FILTER_EXTRA, this);
//        String[] extras = new String[criterias.size()];
//        for (int i = 0; i < extras.length; i++) {
//            extras[i] = criterias.get(i).toStringExtra();
//        }
...
//        bundle.putString(SORT_ORDER_EXTRA, getSortOrder());
    ...
    public static WhereFilter fromBundle(Bundle bundle) {
        WhereFilter filter = bundle.getParcelable(FILTER_EXTRA);
        if (filter == null) filter = WhereFilter.empty();
        return filter;
...
//        return filter;
    ...
    public void toIntent(Intent intent) {
        intent.putExtra(FILTER_EXTRA, this);
    }

    public static WhereFilter fromIntent(Intent intent) {
        return intent.getParcelableExtra(FILTER_EXTRA);
    }
